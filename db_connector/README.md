...
- `api_unified_person.py` provides permanent non-recycled Unified Person
  numbers, immutable assignment/alias lineage, restartable backfill, exact
  source-lineage recovery after technical recreation, and daily integrity
  auditing. See [`UNIFIED_PERSON_OPERATIONS.md`](UNIFIED_PERSON_OPERATIONS.md).
...
for the verified boundary, [`UNIFIED_PERSON_OPERATIONS.md`](UNIFIED_PERSON_OPERATIONS.md)
for permanent-number operation, [`ERPNext_SERVER_MIGRATION_RUNBOOK.md`](ERPNext_SERVER_MIGRATION_RUNBOOK.md)
for transfer, and
