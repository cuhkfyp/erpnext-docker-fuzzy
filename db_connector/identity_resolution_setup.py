...
def _add_indexes() -> None:
    indexes = (
        ...
        ("CCD Match Recommendation", ["canary_run", "status", "cluster_fingerprint"], "ccd_rec_run_status_cluster"),
        ("CCD Match Recommendation Event", ["canary_run"], "ccd_rec_event_run"),
        ("CCD Match Component Review", ["canary_run", "review_status"], "ccd_component_run_review"),
        ("CCD Match Component Review", ["canary_run", "cluster_fingerprint"], "ccd_component_run_cluster"),
